...
TopPlaces.get('/seed', async (req, res) => {
    const topPlaces = [
        {
            name: 'South Island',
        ...
        },
        {
            ...
            descritption: "Snow-capped peaks and azure lakes are just two reasons why Glacier National Park is one of America's most striking parks. There are more than 700 miles of hiking trails in this Montana park, plus 13 designated areas for camping. In winter, travelers can enjoy snowshoeing and skiing, while summer is when vacationers can go swimming and whitewater rafting, among other popular activities. For those who'd rather admire their surroundings from their car, a scenic drive along Going-to-the-Sun Road can't be missed." ,
            likes: 2665,
    ...
    try {
        const seedItems = await TopPlaces.create(topPlaces)
        res.send(seedItems)
    } catch (err) {
